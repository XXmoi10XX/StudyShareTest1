                ...
                <section id="menu">
                    <div class="container">
                        ...
                        <div class="nav nav-tabs" id="tab-menus" role="tablist">
                            <!-- タブ01~08 -->
                            @for ($i = 0+1; $i < 8+1; $i++) <a class="nav-item nav-link" id="tab-menu0{{ $i }}" data-toggle="tab" href="#panel-menu0{{ $i }}" role="tab" aria-controls="panel-menu0{{ $i }}" aria-selected="false">chapter {{ $i }}</a>
                                @endfor
