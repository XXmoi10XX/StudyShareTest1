                ...
                <section id="menu">
                    <div class="container">
                        ...
                        <div class="nav nav-tabs" id="tab-menus" role="tablist">
                            ＠for ($num = 0+1 ; $sum < 8+1; $num++) <a class="nav-item nav-link" id="tab-menu0{{ $num }}" data-toggle="tab" href="#panel-menu0{{ $num }}" role="tab" aria-controls="panel-menu0{{$num}}" aria-selected="false">chapter</a>
