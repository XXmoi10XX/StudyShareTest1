                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="card-text">
                                    <form method="POST" action="{{ route('articles.store') }}">
                                        ...
                                        <div class="md-form">
                                            <label></label>
                                            <input type="text" name="ch" class="form-control" placeholder="Chapterを1~8で選択してください" 　required value="{{ old('ch') }}">
                                        </div>
                                        <!-- <div class="form-group">
                                            ...
                                            <select class="custom-select bg-light form-control">
                                                ...
                                                @for ($num = 0 + 1; $num < 8 + 1; $num++) { <option name="ch" value="ch" required>{{$num}}</option>
