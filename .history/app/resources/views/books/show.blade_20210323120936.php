                                    ...
                                    <form method="POST" action="{{ route('articles.store') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select bg-light form-control">
                                                ...
                                                @for ($num = 0 + 1; $num < 8 + 1; $num++) { <option required value="{{ old('ch')}}">{{$num}}</option>


                                                    }
                                                    @endfor
                                                    <input hidden type="text" name="ch" class="form-control" placeholder="タイトル" 　required value="{{ old('ch') }}">
