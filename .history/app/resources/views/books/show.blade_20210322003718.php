                ...
                <section id="menu">
                    <div class="container">
                        ...
                        <div class="nav nav-tabs" id="tab-menus" role="tablist">
                            @for ($i = 0; $i < 10; $i++) <a class="nav-item nav-link" id="tab-menu02" data-toggle="tab" href="#panel-menu02" role="tab" aria-controls="panel-menu02" aria-selected="false">chapter2</a> @endfor
                                <!-- タブ01 -->
