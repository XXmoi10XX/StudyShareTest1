                ...
                <section id="menu">
                    <div class="container">
                        ...
                        <div class="tab-content" id="panel-menus">
                            <!-- パネル01 -->
                            @for ($i = 1+1; $i < 8+1; $i++) <div class="tab-pane fade show active border border-top-0" id="panel-menu0{{ $i }}" role="tabpanel" aria-labelledby="tab-menu0{{ $i }}">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <a href="/book/{{$book['id']}}/create">投稿する</a>
