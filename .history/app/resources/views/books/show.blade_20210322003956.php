                ...
                <section id="menu">
                    <div class="container">
                        ...
                        <div class="nav nav-tabs" id="tab-menus" role="tablist">
                            @for ($i = 0+1; $i < 8+1; $i++) <a class="nav-item nav-link" id="tab-menu0{{ $num }}" data-toggle="tab" href="#panel-menu02" role="tab" aria-controls="panel-menu02" aria-selected="false">chapter {{ $i }}</a> @endfor
                                <!-- タブ01 -->
